            ...
            if(mode=='t') {
                ...
                if(mode >= 'A' && mode <= 'z') {
                    switch(mode) {
                        ...
                        case 'h': config_reverb(reverb.level, atoff(message + start), reverb.damping, reverb.xover_hz, reverb.do_early); break;
                        ...
                        case 'j': config_reverb(reverb.level, reverb.liveness, atoff(message + start), reverb.xover_hz, reverb.do_early); break;
                        case 'J': config_reverb(reverb.level, reverb.liveness, reverb.damping, atoff(message + start), reverb.do_early); break;
                        ...
                        case 'Q': e.pan = atoff(fmessage + start); break;
                        ...
                        case 'u': config_reverb(atoff(message + start), reverb.liveness, reverb.damping, reverb.xover_hz, reverb.do_early); break;
